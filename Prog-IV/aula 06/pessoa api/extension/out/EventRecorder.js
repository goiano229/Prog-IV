...
class EventRecorder {
    ...
    start() {
        this.disposables.push(vscode.workspace.onDidChangeTextDocument(this.onTextChange, this), vscode.workspace.onDidOpenTextDocument(this.onFileOpen, this), vscode.workspace.onDidSaveTextDocument(this.onFileSave, this));
    }
    stop() {
    ...
    onTextChange(e) {
        ...
        for (const change of e.contentChanges) {
            ...
            const { isPaste, timeSinceLastEvent } = this.pasteDetector.check(charCount, nowMs);
            let type;
            if (charCount === 0) {
                type = 'DELETE';
            }
            ...
            const event = {
                ...
                rangeStartChar: change.range.start.character,
                rangeEndLine: change.range.end.line,
                rangeEndChar: change.range.end.character,
